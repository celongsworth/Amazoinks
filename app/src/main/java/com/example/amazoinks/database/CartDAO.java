...
public interface CartDAO {
    ...
    */
    ...
    @Query("Select itemName, price, category, " + AppDatabase.SHOPPING_CART_TABLE
            + ".itemQuantity from " + AppDatabase.PRODUCT_TABLE
            + " inner join " + AppDatabase.SHOPPING_CART_TABLE
            + " on " + AppDatabase.PRODUCT_TABLE + ".id = "
            + AppDatabase.SHOPPING_CART_TABLE + ".itemID where "
            + AppDatabase.SHOPPING_CART_TABLE + ".userID == :userID")
